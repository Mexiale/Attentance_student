...
detector = cv2.CascadeClassifier(BASE_DIR +'/Etudiants/haarcascade_frontalface_default.xml')
...
class FaceRecognition:    
    ...
    def faceDetect(self, Entry1,):
        ...
        while(True):
            ...
            for (x,y,w,h) in faces:
                ...
                cv2.imwrite(BASE_DIR+'/Etudiants/dataset/User.' + str(face_id) + '.' + str(count) + ".jpg", gray[y:y+h,x:x+w])
    ...
    def trainFace(self):
        ...
        path = BASE_DIR+'/Etudiants/dataset'
        ...
        recognizer.save(BASE_DIR+'/Etudiants/trainer/Trainner.yml') # recognizer.save() worked on Mac, but not on Pi
    ...
    def recognizeFace(self):
        recognizer.read(BASE_DIR+'/Etudiants/trainer/Trainner.yml')
        cascadePath = BASE_DIR+'/Etudiants/haarcascade_frontalface_default.xml'
